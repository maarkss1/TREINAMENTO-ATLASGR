# TELA: Painel de Administração

## Identificação
- **ID da Tela:** `SCR-ADMIN`
- **Rota Canonical:** `/admin`
- **Arquivo de Código Fonte:** `apps/portal/app/admin/page.tsx`
...
- **Gravação de Vídeo:** `../videos/06-admin.webm`
