# TELA: Showcase Atlas Connect

## Identificação
- **ID da Tela:** `SCR-PRODUTOS-CONNECT`
- **Rota Canonical:** `/produtos/connect`
...
## Evidências Visuais
- **Screenshot Inicial:** `../imagens/telas/connect/01-inicio.png`
- **Screenshot Full Page:** `../imagens/telas/connect/02-full-page.png`
