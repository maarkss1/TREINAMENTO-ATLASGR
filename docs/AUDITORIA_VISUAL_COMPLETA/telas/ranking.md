# TELA: Ranking Global de Alunos

## Identificação
- **ID da Tela:** `SCR-RANKING`
- **Rota Canonical:** `/ranking`
- **Arquivo de Código Fonte:** `apps/portal/app/ranking/page.tsx`
...
- **Gravação de Vídeo:** `../videos/08-shorts-e-glossario.webm`
