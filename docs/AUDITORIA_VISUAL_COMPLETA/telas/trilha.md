# TELA: Trilha de Conhecimento

## Identificação
- **ID da Tela:** `SCR-TRILHA`
- **Rota Canonical:** `/trilha`
- **Arquivo de Código Fonte:** `apps/portal/app/trilha/page.tsx`
...
- **Gravação de Vídeo:** `../videos/02-navegacao-trilha.webm`
