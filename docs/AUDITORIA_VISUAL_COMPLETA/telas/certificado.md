...
## Identificação
- **ID da Tela:** `SCR-CERTIFICADO`
- **Rota Canonical:** `/certificado`
- **Arquivo de Código Fonte:** `apps/portal/app/certificado/page.tsx`
...
- **Gravação de Vídeo:** `../videos/05-certificado.webm`
