...
## Identificação
- **ID da Tela:** `SCR-DASHBOARD`
- **Rota Canonical:** `/dashboard`
- **Arquivo de Código Fonte:** `apps/portal/app/dashboard/page.tsx`
...
- **Gravação de Vídeo:** `../videos/01-home-ate-dashboard.webm`
