# TELA: Showcase B.I. & Analytics

## Identificação
- **ID da Tela:** `SCR-PRODUTOS-ANALYTICS`
- **Rota Canonical:** `/produtos/analytics`
...
## Evidências Visuais
- **Screenshot Inicial:** `../imagens/telas/analytics/01-inicio.png`
- **Screenshot Full Page:** `../imagens/telas/analytics/02-full-page.png`
