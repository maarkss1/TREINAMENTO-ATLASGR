# TELA: Prova Final de Certificação

## Identificação
- **ID da Tela:** `SCR-PROVA-FINAL`
- **Rota Canonical:** `/prova-final`
- **Arquivo de Código Fonte:** `apps/portal/app/prova-final/page.tsx`
...
- **Gravação de Vídeo:** `../videos/04-prova-final.webm`
